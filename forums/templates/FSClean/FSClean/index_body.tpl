...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="14" align="center">
  ...
  <table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline">
	<tr> 
	  <td class="catHead" height="28" align="center"><a name="login"></a><span class="cattitle">{L_LOGIN_LOGOUT}</span></td>
	</tr>
	<tr> 
...
<table width="100%" cellpadding="3" cellspacing="1" border="0" class="forumline" align="center">
  <tr> 
	<td class="catHead" colspan="2" height="28" align="center"><span class="cattitle"><a href="{U_VIEWONLINE}" class="cattitle">{L_WHO_IS_ONLINE}</a></span></td>
  </tr>
  <tr> 
	<td class="row1" align="center" valign="middle" rowspan="2"><img src="templates/FSClean/images/whosonline.gif" alt="{L_WHO_IS_ONLINE}" /></td>
...
<table width="100%" cellpadding="1" cellspacing="1" border="0" align="center">
	<td align="center" valign="top"><span class="gensmall">{L_ONLINE_EXPLAIN}</span></td>
</table>
<br />
...
<br />
<!-- BEGIN catrow -->
<table border="0" cellpadding="0" cellspacing="0" width="40%" height="14" align="center">
  <tr> 
    <td rowspan="1" colspan="1" width="1%" height="14" background="templates/FSClean/images/front/Image2_1x2.gif" align="left"> 
      <img name="Image20" src="templates/FSClean/images/front/Image2_1x1.gif" width="5" height="14" border="0"></td>
    <td rowspan="1" colspan="1" width="98%" height="14" background="templates/FSClean/images/front/Image2_1x2.gif" align="center" valign="top" nowrap>     
...
<table width="70%" cellpadding="2" cellspacing="2" class="forumline" height="24" align="center">
<tr>
<td align="center" height="100%" valign="middle">
<span class="gen"><b><a href="{catrow.U_VIEWCAT}" class="small">{catrow.CAT_DESC}</a></b></span>
</td>
</tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" width="40%" height="14" align="center">
...
<br />
  <!-- END catrow -->
<table width="70%" cellspacing="0" border="0" align="center" cellpadding="2" class="forumline" align="center">
  <tr> 
...
<table cellspacing="3" border="0" align="center" cellpadding="0" class="forumline">
  <tr> 
	<td width="20" align="center"><img src="templates/FSClean/images/folder_new_big.gif" alt="{L_NEW_POSTS}"/></td>
	<td><span class="gensmall">{L_NEW_POSTS}</span></td>
	<td>&nbsp;&nbsp;</td>
	<td width="20" align="center"><img src="templates/FSClean/images/folder_big.gif" alt="{L_NO_NEW_POSTS}" /></td>
	<td><span class="gensmall">{L_NO_NEW_POSTS}</span></td>
	<td>&nbsp;&nbsp;</td>
	<td width="20" align="center"><img src="templates/FSClean/images/folder_locked_big.gif" alt="{L_FORUM_LOCKED}" /></td>
