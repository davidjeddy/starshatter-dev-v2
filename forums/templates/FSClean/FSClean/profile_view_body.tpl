...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
  ...
  <tr> 
	...
	<td class="row1" rowspan="3" valign="top">
		...
		<tr> 
		  <td valign="top" align="right" nowrap="nowrap"><span class="gen">{L_REFERRAL_TOTAL}:</span></td>
		  <td> <b><span class="gen">{REFERRAL_TOTAL}</span></b></td>
		</tr>
		<tr> 
		  <td valign="top" align="right" nowrap="nowrap">&nbsp;</td>
		  <td><span class="gen">{L_REFERRAL_URL}</span></td>
		</tr>
	  </table>
	</td>
  </tr>
