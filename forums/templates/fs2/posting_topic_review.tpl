...
<table cellpadding="0" cellspacing="1" width="100%" class="forumline">
	<tr> 
		<td class="catHead"><div class="center"><span class="cattitle"><b>{L_TOPIC_REVIEW}</b></span></div></td>
	</tr>
	<tr>
...
<table cellpadding="0" cellspacing="1" width="100%" class="forumline">
	...
	<tr>
		...
		<td class="{postrow.ROW_CLASS}" valign="top"><table width="100%" cellspacing="0" cellpadding="0">
			<tr> 
	...
	<tr> 
		<td colspan="2" height="1" class="spaceRow"><img src="templates/fs2/images/spacer.gif" alt="" width="1" height="1" /></td>
	</tr>
	 <!-- END postrow -->
</table>
<!-- BEGIN switch_inline_mode -->
