...
<table cellpadding="0" cellspacing="1" width="100%" class="forumline">
	<tr> 
		<th colspan="2" valign="middle">{L_REGISTRATION_INFO}</th>
	</tr>
	<tr> 
	...
	<tr> 
	  <th colspan="2" valign="middle">{L_PROFILE_INFO}</th>
	</tr>
	<tr> 
	...
	<tr> 
	  <th colspan="2" valign="middle">{L_PREFERENCES}</th>
	</tr>
	<tr> 
	...
	<tr>
		<td class="catBottom" colspan="2"><div class="center">{S_HIDDEN_FIELDS}<input type="submit" name="submit" value="{L_SUBMIT}" class="mainoption" />&nbsp;&nbsp;<input type="reset" value="{L_RESET}" name="reset" class="liteoption" /></div></td>
	</tr>
</table></form>
