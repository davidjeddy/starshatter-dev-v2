...
if(file_exists("userFiles/lists/sw_Cruiser.php"))
	{
		print "
<TABLE WIDTH=\"100%\" BORDER=\"0\" BORDERCOLOR=\"#ffff88\" CELLSPACING=\"2\" CELLPADDING=\"0\">
	<TR ALIGN=\"left\"> 
		...
		include ('userFiles/lists/sw_Cruiser.php');
	}

if(file_exists("userFiles/lists/sw_Carrier.php"))
	{
		print "
<TABLE WIDTH=\"100%\" BORDER=\"0\" BORDERCOLOR=\"#ffff88\" CELLSPACING=\"2\" CELLPADDING=\"0\">
	<TR ALIGN=\"left\"> 
		...
		include ('userFiles/lists/sw_Carrier.php');
	}

if(file_exists("userFiles/lists/sw_Drednaught.php"))
	{
		print "
<TABLE WIDTH=\"100%\" BORDER=\"0\" BORDERCOLOR=\"#ffff88\" CELLSPACING=\"2\" CELLPADDING=\"0\">
	<TR ALIGN=\"left\"> 
		...
		include ('userFiles/lists/sw_Drednaught.php');
	}

if(file_exists("userFiles/lists/sw_Freighter.php"))
	{
		print "
<TABLE WIDTH=\"100%\" BORDER=\"0\" BORDERCOLOR=\"#ffff88\" CELLSPACING=\"2\" CELLPADDING=\"0\">
	<TR ALIGN=\"left\"> 
		...
		include ('userFiles/lists/sw_Freighter.php');
	}
