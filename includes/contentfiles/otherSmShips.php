...
if(file_exists("userFiles/lists/other_drone.php"))
	{
		print "
<TABLE WIDTH=\"100%\" BORDER=\"0\" BORDERCOLOR=\"#ffff88\" CELLSPACING=\"2\" CELLPADDING=\"0\">
	<TR ALIGN=\"left\"> 
		...
		include ('userFiles/lists/other_drone.php');
	}

if(file_exists("userFiles/lists/other_fighter.php"))
	{
		print "
<TABLE WIDTH=\"100%\" BORDER=\"0\" BORDERCOLOR=\"#ffff88\" CELLSPACING=\"2\" CELLPADDING=\"0\">
	<TR ALIGN=\"left\"> 
		...
		include ('userFiles/lists/other_fighter.php');
	}

if(file_exists("userFiles/lists/other_attack.php"))
	{
		print "
<TABLE WIDTH=\"100%\" BORDER=\"0\" BORDERCOLOR=\"#ffff88\" CELLSPACING=\"2\" CELLPADDING=\"0\">
	<TR ALIGN=\"left\"> 
		...
		include ('userFiles/lists/other_attack.php');
	}

if(file_exists("userFiles/lists/other_lca.php"))
	{
		print "
<TABLE WIDTH=\"100%\" BORDER=\"0\" BORDERCOLOR=\"#ffff88\" CELLSPACING=\"2\" CELLPADDING=\"0\">
	<TR ALIGN=\"left\"> 
		...
		include ('userFiles/lists/other_lca.php');
	}
