...
if(file_exists("userFiles/lists/b5_drone.php"))
	{
		print "
<TABLE WIDTH=\"100%\" BORDER=\"0\" BORDERCOLOR=\"#ffff88\" CELLSPACING=\"2\" CELLPADDING=\"0\">
	<TR ALIGN=\"left\"> 
		...
		include ('userFiles/lists/b5_drone.php');
	}

if(file_exists("userFiles/lists/b5_fighter.php"))
	{
		print "
<TABLE WIDTH=\"100%\" BORDER=\"0\" BORDERCOLOR=\"#ffff88\" CELLSPACING=\"2\" CELLPADDING=\"0\">
	<TR ALIGN=\"left\"> 
		...
		include ('userFiles/lists/b5_fighter.php');
	}

if(file_exists("userFiles/lists/b5_attack.php"))
	{
		print "
<TABLE WIDTH=\"100%\" BORDER=\"0\" BORDERCOLOR=\"#ffff88\" CELLSPACING=\"2\" CELLPADDING=\"0\">
	<TR ALIGN=\"left\"> 
		...
		include ('userFiles/lists/ob5_attack.php');
	}

if(file_exists("userFiles/lists/b5_lca.php"))
	{
		print "
<TABLE WIDTH=\"100%\" BORDER=\"0\" BORDERCOLOR=\"#ffff88\" CELLSPACING=\"2\" CELLPADDING=\"0\">
	<TR ALIGN=\"left\"> 
		...
		include ('userFiles/lists/b5_lca.php');
	}
