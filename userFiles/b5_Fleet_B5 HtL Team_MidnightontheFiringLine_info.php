...
<TABLE WIDTH="50%" BORDER="0" BORDERCOLOR="#ffff88" CELLSPACING="2" CELLPADDING="0">
	<TR ALIGN="center"> 
		<TD HEIGHT="29" BACKGROUND="interfaces/default/SideMenuTitle.png">
			<FONT CLASS="default">B5 HtL Team's Midnight on the Firing Line Info</font>
		</TD>
	</TR>
</table>
...
<TABLE WIDTH="50%" BORDER="0" BORDERCOLOR="#ffff88" CELLSPACING="2" CELLPADDING="0">
	...
	<TR>
		<TD ALIGN="center" VALIGN="left" BGCOLOR="#E8E984" colspan="3">File Type: Dat
		</td>
	</tr>
	<tr>
		<td  align="left" valign="top" bgcolor="#E8E984" colspan="3">Creators Comments:<br>&nbsp;&nbsp;&nbsp;First Release from the Babylon 5 Hold the Line Team. This is a BETA release so not EVERYTHING will be functional but it is very playable. Have fun. :)</td>
	</tr>
