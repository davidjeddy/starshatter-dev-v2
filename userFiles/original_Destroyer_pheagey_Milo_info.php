...
<TABLE WIDTH="50%" BORDER="0" BORDERCOLOR="#ffff88" CELLSPACING="2" CELLPADDING="0">
	<TR ALIGN="center"> 
		<TD HEIGHT="29" BACKGROUND="interfaces/default/SideMenuTitle.png">
			<FONT CLASS="default">pheagey's Milo Info</font>
		</TD>
	</TR>
</table>
...
<TABLE WIDTH="50%" BORDER="0" BORDERCOLOR="#ffff88" CELLSPACING="2" CELLPADDING="0">
	...
	<tr>
		<td  align="left" valign="top" bgcolor="#E8E984" colspan="3">Creators Comments:<br>&nbsp;&nbsp;&nbsp;The Milo Class is one of the C.E.s newest ships. It is quickly replacing many of the aging ships in the CE. Have fun. :)</td>
	</tr>
